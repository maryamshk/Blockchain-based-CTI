...
#       Copies the ../../setup/config/five-org/crypto.1/crypto-config.yaml
#       Copies the ../../setup/config/five-org/policy.1/configtx.yaml
#       Copies the ../../setup/config/five-org/orderer.1/orderer.yaml
...
BASE_CONFIG_DIR=../../setup/config/five-org
